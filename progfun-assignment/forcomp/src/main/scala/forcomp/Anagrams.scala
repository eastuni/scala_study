...
object Anagrams {
   ...
   */
  def subtract(x: Occurrences, y: Occurrences): Occurrences = (x ::: y).groupBy{t => t._1}.map(
      z => if(z._2.length==2) (z._1, z._2.apply(0)._2 -  z._2.apply(1)._2) else (z._1, z._2.apply(0)._2)
    ).filter(j => j._2!=0).toList.sortBy(u => u._1)
