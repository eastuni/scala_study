...
class Empty extends TweetSet {
  ...
  override def findMax: Tweet = new Tweet("","",-1)
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  override def findMax: Tweet = {
    def max(a: Tweet, b: Tweet, c:Tweet): Tweet =
      ...
      else if(b.retweets > a.retweets && b.retweets > c.retweets) c
      else c
    max(elem,left.findMax,right.findMax)
  }
